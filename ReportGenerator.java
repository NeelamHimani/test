...
public class ReportGenerator {
	...
	public void startReport() {
		...
		reporter = new ExtentReports(System.getProperty("user.dir") + "/test-output/STMExtentReport.html", true);
		// extent.addSystemInfo("Environment","Environment Name")
		reporter.addSystemInfo("Host Name", "SoftwareTestingMaterial")
	...
	public void passTest() {
		...
		// Starting test
		logger = reporter.startTest("passTest");
	...
	public void failTest() {
		logger = reporter.startTest("failTest");
	...
	public void skipTest() {
		logger = reporter.startTest("skipTest");
